...
//--------------------------------------------------------------
void ciCEFRenderHandler::init(void){
...
//--------------------------------------------------------------
void ciCEFRenderHandler::reshape(int w_, int h_){
    w = w_;
    h = h_;
...
//--------------------------------------------------------------
void ciCEFRenderHandler::OnPopupShow(CefRefPtr<CefBrowser> browser,
                                      bool show) {
    if (!show) {
...
//--------------------------------------------------------------
void ciCEFRenderHandler::OnPopupSize(CefRefPtr<CefBrowser> browser,
                                      const CefRect& rect) {
...
//--------------------------------------------------------------
CefRect ciCEFRenderHandler::GetPopupRectInWebView(const CefRect& original_rect) {
...
//--------------------------------------------------------------
void ciCEFRenderHandler::ClearPopupRects() {
    popup_rect_.Set(0, 0, 0, 0);
    original_popup_rect_.Set(0, 0, 0, 0);
}

//--------------------------------------------------------------
bool ciCEFRenderHandler::GetScreenInfo(CefRefPtr<CefBrowser> browser,
...
//--------------------------------------------------------------
bool ciCEFRenderHandler::GetViewRect(CefRefPtr<CefBrowser> browser, CefRect &rect){
...
//--------------------------------------------------------------
/*
void ciCEFRenderHandler::render() {
